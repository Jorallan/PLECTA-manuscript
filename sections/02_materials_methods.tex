...
PLECTA selects compatible connections by balancing the cost of linking two
stubs against the penalties for leaving them unmatched. For stubs $i$ and $j$,
a link is admissible when its cost $C_{ij}$ is less than the combined unmatched
penalties $p_i+p_j$. Exact maximum-weight partial matching selects a set of
disjoint pairs $\mathcal M$:
\begin{equation}
  \max_{\mathcal M}\sum_{(i,j)\in\mathcal M}
