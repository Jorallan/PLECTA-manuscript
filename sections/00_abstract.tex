...
fragments. We present PLECTA (from Latin \emph{plecta}, a braid), a
deterministic method that segments individual strands using only a binary
image whose foreground pixels mark strand centrelines. At each junction,
PLECTA selects which strand segments continue into one another while
allowing segments to terminate. It formulates
