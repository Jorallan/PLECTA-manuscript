...
Predictive models of strand networks take per-strand geometry as their input,
and load transfer between neighbouring nanotubes, for instance, can limit an
assembly's stiffness and strength despite the high modulus of each individual
tube \citep{devolder2013cnt,coleman2006small,volkov2010structural,%
...
one object from another, is mature:
U-Net and
...
resolving them. Instance methods go further and label each object separately, but they assume
those objects are compact, in materials microscopy
...
schmidt2018stardist,kirillov2023sam}. Ridge and vesselness filters, which score each pixel by how strongly the local
image curvature resembles a line or a tube, sharpen
...
coverage and alignment \citep{dong2022detecting,imtiaz2023facile,%
beigzadeh2024utilizing}. Where the imaging is volumetric, strands that appear to meet in projection
