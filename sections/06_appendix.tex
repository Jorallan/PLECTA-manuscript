...
are plain means of ten scenes with no interval drawn and none claimed. On the
...
The real-field block of Table~\ref{tab:plecta-comparators} is a mean over
\PlectaRealFieldCountLower{} fields, and one of them runs against it. PLECTA's
pairwise \Fone{} margin over SIFNE is
\PlectaRealSifneDeltaBFiveEightOneZeroZero{},
\PlectaRealSifneDeltaBFiveEightOneOneZero{} and
\PlectaRealSifneDeltaBFiveEightThreeZeroZero{} on B58\_100, B58\_110 and
B58\_300, so on the first of them SIFNE takes the pairwise score. PLECTA leads
that field on join \Fone{} and on detection \Fone{}, and leads all
\PlectaRealFieldCountLower{} on every measure in the mean.
