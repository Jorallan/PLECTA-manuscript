...
divides from one that fuses. Blind spot: each component alone is degenerate ---
a method merging everything never splits anything and scores a perfect zero on
...
which is the over-marking Section~\ref{sec:res-overlap} reports.
