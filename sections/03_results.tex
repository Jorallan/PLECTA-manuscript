...
\begin{figure}[!t]
  ...
  \caption{Five methods on identical masks, by coverage. The upper row uses
    ...
    fragmentation. All methods receive the same masks and are scored by the
    same code, and each was configured on development scenes rather than left
    at its defaults. Crossing Fidelity is reported in
